...
<head>
  ...
  <title>Client - Dewanstudio Power Management</title>
              ...
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <div class="heading-elements">
                    ...
                    <a href="<?=base_url()?>client/add"><button class="btn btn-primary btn-md"><i class="ft-plus white"></i> ADD CLIENT</button></a>
                      ...
                      <table id="project-bugs-list" class="table table-bordered row-grouping display no-wrap icheck table-middle">
                        ...
                        <?php foreach ($row as $key => $isi) { ?>
                          ...
                          <tr>
                            ...
                            <td rowspan="6"><p class="text-bold-600"><?=$i?></p></td>
                            ...
                            <td rowspan="6">
                              ...
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                  ...
                                  <a href="<?=base_url()?>client/edit/<?=$isi['id'];?>" class="dropdown-item"><i class="ft-edit-2"></i> Edit</a>

                                  <a href="<?=base_url()?>client/delete/<?=$isi['id'];?>" class="dropdown-item"><i class="ft-trash"></i> Delete</a>
                          ...
                          <tr>
                            ...
                            <td><?=$isi['surname_client'];?></td>
                          </tr>
                          <tr>
                            <td>CLIENT ADDRESS</td>
                            <td><?=$isi['alamat_client'];?></td>
                          </tr>
                          <tr>
                            <td>CLIENT PHONE</td>
                            <td><?=$isi['telepon_client'];?></td>
                          </tr>
                          <tr>
                            <td>CLIENT EMAIL</td>
                            <td><?=$isi['email_client'];?></td>
                          </tr>
                          <tr>
                            <td>DATE ADDED</td>
                            <td><?php echo date('d F Y', strtotime($isi['date'])); ?></td>
                          </tr>
