...
<head>
  ...
  <title>Edit Client - Dewanstudio Power Management</title>
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-wrapper">
		...
		<div>
			...
			<h1 class="text-center" style="padding:40px 0 40px 0;"><b>EDIT CLIENT</b></h1>
                        ...
                        <div class="form-group row">
                        	...
                        	<div class="col-md-6 pb-xl-1 py-xl-1">
                        	  ...
                        	  <h5 class="pb-xl-1 py-xl-1">Client Name</h5>
	                            ...
	                            <input type="text" id="projectinput1" class="form-control" placeholder="Client Name" value="<?=$row->nama_client?>" name="name">
                          ...
                          <div class="col-md-6 pb-xl-1 py-xl-1">
                            ...
                            <h5 class="pb-xl-1 py-xl-1">Client Surname Name (Optional)</h5>
                              ...
                              <input type="text" id="projectinput1" class="form-control" placeholder="Client Surename" value="<?=$row->surname_client?>" name="surname">
                          ...
                          <div class="col-lg-12">
                              ...
                              <textarea id="" rows="5" class="form-control" name="address" placeholder="Client Address"><?=$row->alamat_client?></textarea>
                          ...
                          <div class="col-md-6 pb-xl-1 py-xl-1">
                            ...
                            <input type="text" id="projectinput1" value="<?=$row->telepon_client?>" class="form-control" placeholder="Client Phone Number" name="phone">
                          </div>
                          ...
                          <div class="col-md-6 pb-xl-1 py-xl-1">
                            ...
                            <input type="email" id="projectinput1" value="<?=$row->email_client?>" class="form-control" placeholder="Client Email" name="email">
                          </div>
