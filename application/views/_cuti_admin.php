                            ...
                            <td>
                              ...
                              <span class="dropdown">
                                  ...
                                  <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                    ...
                                    <a href="<?=base_url()?>cuti/approve?a=<?=$cuti['id']?>&x=1&u=<?=$cuti['id_user']?>&alasan=<?=$cuti['alasan']?>&tanggalmulai=<?=$cuti['tanggal_mulai']?>&tanggalakhir=<?=$cuti['tanggal_akhir']?>" class="dropdown-item info">
