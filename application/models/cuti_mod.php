...
class Cuti_mod extends CI_Model {
    ...
    function tampil_sisa_cuti(){
        // return $this->db->get('ds_jumlah_cuti');
        return $this->db->query('SELECT ds_jumlah_cuti.cuti , ds_users.name FROM ds_jumlah_cuti join ds_users ON ds_jumlah_cuti.id_user =ds_users.id WHERE status="aktif"');
